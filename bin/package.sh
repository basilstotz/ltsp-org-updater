...
Version: $VERSION 
Architecture: amd64
Depends: ltsp,ltsp-binaries,curl,webfs,avahi-daemon,avahi-utils,debconf,dnsmasq,nfs-kernel-server,ssh,squashfs-tools,ethtool,net-tools,epoptes,epoptes-client,sshfs,man-db,wget 
